...
- [x] **DATA-02**: A data dictionary and data-quality report document nulls, ranges, outliers, ferry skew (median 12 / max 7,229), the retired-dataset pull-date caveat, and the 5.8% vs 14% underutilization discrepancy as a stated insight
